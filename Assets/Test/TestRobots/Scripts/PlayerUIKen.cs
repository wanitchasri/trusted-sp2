...
namespace Ken.Test
{
	...
	/// </summary>
	public class PlayerUIKen : MonoBehaviour
    {
		public static PlayerUIKen Instance;
		...
		void Awake()
		{
            ...
            //Canvas componentCanvas = _canvasGroup.GetComponent<Canvas>();
            //componentCanvas.sortingOrder = canvas.sortingOrder - 1;
        }
		...
		public void SetTarget(PlayerManagerKen _target){
