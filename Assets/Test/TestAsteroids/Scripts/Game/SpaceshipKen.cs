...
{
    public class SpaceshipKen : MonoBehaviour
    {
...
#pragma warning restore 0109
        ...
        public void Start()
        {
            ...
            {
                r.material.color = AsteroidsGameKen.GetColor(photonView.Owner.GetPlayerNumber());
            }
        }
        ...
        {
            yield return new WaitForSeconds(AsteroidsGameKen.PLAYER_RESPAWN_TIME);
        ...
        public void DestroySpaceship()
        {
            ...
            {
                object lives;
                if (PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(AsteroidsGameKen.PLAYER_LIVES, out lives))
                {
                    PhotonNetwork.LocalPlayer.SetCustomProperties(new Hashtable {{AsteroidsGameKen.PLAYER_LIVES, ((int) lives <= 1) ? 0 : ((int) lives - 1)}});
        ...
        public void Fire(Vector3 position, Quaternion rotation, PhotonMessageInfo info)
        {
            ...
            bullet.GetComponent<BulletKen>().InitializeBullet(photonView.Owner, (rotation * Vector3.forward), Mathf.Abs(lag));
