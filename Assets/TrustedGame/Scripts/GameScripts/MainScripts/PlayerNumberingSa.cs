...
/// </remarks>
public class PlayerNumberingSa : MonoBehaviourPunCallbacks
{
    ...
    /// </summary>
    public static PlayerNumberingSa Instance;
    ...
    {
        PhotonNetwork.LocalPlayer.CustomProperties.Remove(PlayerNumberingSa.RoomPlayerIndexedProp);
    }
    ...
    {
        if (changedProps != null && changedProps.ContainsKey(PlayerNumberingSa.RoomPlayerIndexedProp))
        {
            this.RefreshData();
        }
    }
...
public static class PlayerNumberingExtensionsSa
{
    ...
    public static int GetPlayerNumber(this Player player)
    {
        ...
        object value;
        if (player.CustomProperties.TryGetValue(PlayerNumberingSa.RoomPlayerIndexedProp, out value))
        {
            return (byte)value;
        }
        return -1;
    ...
    public static void SetPlayerNumber(this Player player, int playerNumber)
    {
        ...
        if (current != playerNumber)
        {
            ...
            player.SetCustomProperties(new Hashtable() { { PlayerNumberingSa.RoomPlayerIndexedProp, (byte)playerNumber } });
        }
    }
}
