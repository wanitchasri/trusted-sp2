...
#pragma warning disable 649
	...
	/// </summary>
	public class PlayerUISa : MonoBehaviourPunCallbacks
	{
		...
		void Update()
		{
			...
			if (target == null || target.gameObject.name.Contains("CloneFor"))
			{
		...
		public void SetTarget(PlayerManagerSa _target)
		{
			if (_target == null || _target.gameObject.name.Contains("CloneFor")) {
