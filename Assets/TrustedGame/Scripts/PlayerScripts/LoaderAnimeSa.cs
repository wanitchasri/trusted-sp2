...
namespace SENKOJI.Test
{
	...
	/// 
	/// </summary>
	public class LoaderAnimeSa : MonoBehaviour {
		...
		void Update () 
		{
			myCurrentBody = PlayerManagerSa.Instance.myCurrentBody;
			//if (myCurrentBody != null) { _transform = myCurrentBody.GetComponent<Transform>(); }
