...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public static void Replace(GameObject playerPrefab2, GameObject playerPrefab1)
        {
            throw new NotImplementedException();
        }

        public static void Replace(GameObject[] oldChar, GameObject playerPrefab2)
        {
            throw new NotImplementedException();
        }
        ...
        public static object whatToSpawnClone;
